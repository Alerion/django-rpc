...
def main():
    """Run the tests for djangorpc and generate a coverage report."""
    ...
    project_dir = os.path.dirname(djangorpc.__file__)
    cov_files = []
    ...
    for (path, dirs, files) in os.walk(project_dir):
        ...
        if 'djangorpc.py' in files:
            files.remove('djangorpc.py')
